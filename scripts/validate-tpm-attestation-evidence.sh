...
sealed_key_file="${lythiumseal_operator_key_file:-$sealed_operator_key_file}"
...
verify_file_hash "lythiumseal_operator_key" "$sealed_key_file" "$(field '.attestation.tpm.sealed_key_policy.sealed_operator_key_sha256')" >>"$items"
