...
> release **`protocore v0.1.71-testnet`** (mono-core `553953b7`). The
...
**Apply** to move to `v0.1.71-testnet` if you aren't already on it (you do **not**
...
URL=https://github.com/monolythium/protocore/releases/download/v0.1.71-testnet/protocore-v0.1.71-testnet-x86_64-linux.tar.gz
...
curl -s http://127.0.0.1:8545 -H 'content-type: application/json' \
  -d '{"jsonrpc":"2.0","id":1,"method":"web3_clientVersion","params":[]}'
# expect: protocore/v2/v0.1.71-testnet+553953b7   (match the registry release_tag)
...
(`0x6c76fe49…`) and your height tracks [monoscan.io](https://monoscan.io). Once
