...
| Desktop Talos client | Monarch Desktop has no Talos API mTLS client yet. | Desktop must import/read `talosconfig`, verify identity, call Talos API, and surface service/log/config state. |
